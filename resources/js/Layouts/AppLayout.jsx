...
export default function AppLayout({
    ...
    return (
        <div className="bg-zinc-950 min-h-screen text-white font-sans flex flex-col justify-between">
            ...
            <nav className="fixed top-0 w-full z-50 bg-gradient-to-b from-black/90 to-transparent backdrop-blur-md px-4 py-3 lg:px-8 flex items-center justify-between border-b border-zinc-900/50">
                ...
                {!hideHeroAndSearch ? (
                    <div className="flex-1 max-w-md mx-4">
                        <input
                            ...
                            className="w-full bg-zinc-900/80 text-white border border-zinc-700 focus:border-red-600 focus:ring-1 focus:ring-red-600 rounded-md py-1.5 px-4 text-sm transition"
                        />
                    </div>
                ) : (
